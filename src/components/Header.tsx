...
export default function Header() {
  ...
  return (
    // Fond opaque plutôt que `backdrop-blur` : le flou d'arrière-plan serait
    // recalculé à chaque image pendant le défilement (saccades sur mobile).
    <header className="animate-header-in sticky top-0 z-50 border-b border-navy/10 bg-cream">
